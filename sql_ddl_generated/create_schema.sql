...
CREATE TABLE "Time Period_subjects" (
	"Time Period_id" TEXT, 
...
CREATE TABLE "Off Protocol Therapy Or Study_subjects" (
	"Off Protocol Therapy Or Study_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Medical History_subjects" (
	"Medical History_id" TEXT, 
	subjects_id TEXT NOT NULL, 
	PRIMARY KEY ("Medical History_id", subjects_id), 
	FOREIGN KEY("Medical History_id") REFERENCES "Medical History" (id), 
	FOREIGN KEY(subjects_id) REFERENCES "Subject" (id)
);
CREATE TABLE "Survival Characteristics_subjects" (
	"Survival Characteristics_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Family Medical History_subjects" (
	"Family Medical History_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Vitals And Anthropometrics_subjects" (
	"Vitals And Anthropometrics_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Histology_subjects" (
	"Histology_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Disease Characteristics_subjects" (
	"Disease Characteristics_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Transfusion Medicine Procedures_subjects" (
	"Transfusion Medicine Procedures_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Cellular Immunotherapy_subjects" (
	"Cellular Immunotherapy_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Biopsy And Surgical Procedures_subjects" (
	"Biopsy And Surgical Procedures_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Protocol Treatment Modifications_subjects" (
	"Protocol Treatment Modifications_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Minimal Residual Disease_subjects" (
	"Minimal Residual Disease_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Subject Response_subjects" (
...
CREATE TABLE "Adverse Events_subjects" (
	"Adverse Events_id" TEXT, 
	subjects_id TEXT NOT NULL, 
	PRIMARY KEY ("Adverse Events_id", subjects_id), 
	FOREIGN KEY("Adverse Events_id") REFERENCES "Adverse Events" (id), 
	FOREIGN KEY(subjects_id) REFERENCES "Subject" (id)
);
CREATE TABLE "Subsequent Malignant Neoplasm_subjects" (
	"Subsequent Malignant Neoplasm_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Patient Reported Outcomes Metadata_subjects" (
	"Patient Reported Outcomes Metadata_id" TEXT, 
	subjects_id TEXT NOT NULL, 
...
CREATE TABLE "Late Effects_subjects" (
	"Late Effects_id" TEXT, 
	subjects_id TEXT NOT NULL, 
